    ...
    <div class="am-panel-bd">
        ...
        <form method="post" action="login">
            <div class="am-input-group am-input-group-primary margin">
                ...
                <input type="text" class="am-form-field" placeholder="Email or Username" name="username"
                       maxlength="16"/>
            </div>
            ...
            <button type="button" class="am-btn am-btn-primary am-btn-block login" style="float: left;">Login</button>
            <a class="am-btn am-btn-success am-btn-block login" href="register.html"
               style="float: right; margin-bottom: 6px;">SignUp</a>
        </form>

        <!--其他登录方式js start-->
        <button type="button" style="margin-bottom: 6px;" class="am-btn am-btn-secondary am-btn-block"
