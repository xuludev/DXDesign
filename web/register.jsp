...
<form class="am-form" action="register.action">
    <div class="am-input-group am-input-group-primary xl-div" align="center">
        <span class="am-input-group-label"><i class="am-icon-user am-icon-fw"></i></span>
        <input type="text" class="am-form-field" placeholder="Username" name="username">
    </div>

    <div class="am-input-group am-input-group-success xl-div" align="center">
        <span class="am-input-group-label"><i class="am-icon-lock am-icon-fw"></i></span>
        <input type="password" class="am-form-field" placeholder="Password" name="password">
    </div>

    <div class="am-input-group am-input-group-success xl-div" align="center">
        <span class="am-input-group-label"><i class="am-icon-lock am-icon-fw"></i></span>
        <input type="password" class="am-form-field" placeholder="Password Confirm">
    </div>
    ...
    <div class="am-input-group am-input-group-secondary xl-div" align="center">
        ...
        <input type="email" class="am-form-field" placeholder="Email" name="email">
    </div>

    <div class="am-input-group am-input-group-secondary xl-div" align="center">
        <span class="am-input-group-label"><i class="am-icon-phone-square am-icon-fw"></i></span>
        <input type="text" class="am-form-field" placeholder="Cellphone" name="cellphone">
    </div>

    <div class="am-form-group xl-div">
        <span>您的关注：</span>
        <label class="am-checkbox-inline">
            <input type="checkbox" value="technology" name="newsfocus"> 科技
        </label>
        <label class="am-checkbox-inline">
            <input type="checkbox" value="design" name="newsfocus"> 设计
        </label>
        <label class="am-checkbox-inline">
            <input type="checkbox" value="internet" name="newsfocus"> 互联网
        </label>
        <label class="am-checkbox-inline">
            <input type="checkbox" value="digit" name="newsfocus"> 数码
        </label>
        <label class="am-checkbox-inline">
            <input type="checkbox" value="photograph" name="newsfocus"> 摄影
        </label>
        <label class="am-checkbox-inline">
            <input type="checkbox" value="amusement" name="newsfocus"> 娱乐
        </label>
        <label class="am-checkbox-inline">
            <input type="checkbox" value="cellphone" name="newsfocus"> 手机
        </label>
        <label class="am-checkbox-inline">
            <input type="checkbox" value="tech" name="newsfocus"> 技术
        </label>
        <label class="am-checkbox-inline">
            <input type="checkbox" value="music" name="newsfocus"> 音乐
        </label>
    </div>

    <div class="am-form-group xl-div">
        <label for="doc-select-1">您的职业</label>
        <select id="doc-select-1" name="career">
    ...
    <div class="xl-div">
        ...
        <a type="button" href="index.jsp" class="am-btn am-btn-success am-btn-block" style="margin-top: 6px;">返回主页</a>
        <button type="button" class="am-btn am-btn-default am-btn-block" style="margin-top: 6px;" data-toggle="modal"
                data-target="#myModal">温馨提示
        </button>
    </div>
